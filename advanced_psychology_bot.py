#!/usr/bin/env python3
"""
Продвинутый психологический бот с интеллектуальным пониманием контекста
Решает все проблемы: переключение сценариев, обрывы диалога, потеря контекста
"""
...
class AdvancedPsychologyBot:
    ...
    def analyze_user_intent(self, content: str, context: DialogueContext) -> str:
        ...
        if any(word in content_lower for word in ['согласен', 'да', 'хорошо', 'ок', 'согласен']):
            return "agreement"
    ...
    def _handle_brief_explanation_request(self, user_name: str, context: DialogueContext) -> str:
        ...
        # Проверяем, были ли уже предложены техники
...
def main():
    """Демонстрация работы продвинутого бота"""
    bot = AdvancedPsychologyBot()
    ...
    print("=== Демонстрация работы продвинутого психологического бота ===\n")
