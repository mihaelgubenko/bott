...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    welcome_text = (
        f"🌟 *HR-Психоаналитик | Карьерный консультант*\n\n"
        f"Привет, {user.first_name or 'друг'}! Я ваш персональный помощник в поиске себя и своего пути.\n\n"
        f"━━━━━━━━━━━━━━━━━━━━━━\n"
        f"*🎯 МОИ ВОЗМОЖНОСТИ:*\n\n"
        f"*1️⃣ Психологическая поддержка*\n"
        f"💙 Эмоциональная поддержка\n"
        f"🤝 Консультация по снам, стрессу, отношениям\n"
        f"😌 Помощь с тревогой, страхами и обидами\n\n"
        f"*2️⃣ Анализ личности и карьера*\n"
        f"🧠 Экспресс-анализ (10 сообщений - БЕСПЛАТНО)\n"
        f"💼 Подбор профессии и развития\n"
        f"🎓 Рекомендации по обучению\n\n"
        f"*3️⃣ Глубокий психоанализ*\n"
        f"🔮 Полный анализ (7 вопросов) - 500₽\n"
        f"📊 Профиль по Юнгу, Фрейду, MBTI\n\n"
        f"*4️⃣ Тест Восхождение (НОВИНКА)*\n"
        f"📖 30 вопросов для анализа самооценки\n"
        f"🎯 Работа со страхами, гневом, обидами\n"
        f"✨ Поиск предназначения\n\n"
        f"━━━━━━━━━━━━━━━━━━━━━━\n"
        f"*🚀 КАК НАЧАТЬ:*\n\n"
        f"• Просто напишите о том, что беспокоит\n"
        f"• Или выберите команду:\n\n"
        f"/self\\_esteem - Тест Восхождение\n"
        f"/help - Подробная справка\n"
        f"/consultation - Личная консультация\n\n"
        f"━━━━━━━━━━━━━━━━━━━━━━\n"
        f"💙 *Все конфиденциально и анонимно!*\n\n"
        f"Расскажите, чем могу помочь?"
    )
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    help_text = (
        ...
        "*💡 СОВЕТЫ:*\n\n"
        "1\\. Будьте искренни\n"
        "2\\. Отвечайте развёрнуто\n"
        "3\\. Если не понял \\- скажите\n"
        "4\\. Можете сменить тему\n\n"
        "━━━━━━━━━━━━━━━━━━━━━━\n"
