...
Привет, {name}! Я ваш персональный помощник в поиске себя и своего пути.
...
💙 Эмоциональная поддержка
🤝 Консультация по снам, стрессу, отношениям
😌 Помощь с тревогой, страхами и обидами

**2️⃣ Анализ личности и карьера**
🧠 Экспресс-анализ личности (10 сообщений - БЕСПЛАТНО)
💼 Подбор профессии и направления развития
🎓 Рекомендации по обучению

**3️⃣ Глубокий психоанализ**
🔮 Полный анализ (7 вопросов) - 500₽
📊 Детальный профиль по методам Юнга, Фрейда, MBTI

**4️⃣ Тест "Восхождение" (НОВИНКА!)**
📖 30 вопросов для анализа самооценки
🎯 Работа со страхами, гневом, обидами
...
• Просто напишите мне о том, что вас беспокоит
• Или выберите команду:

/self_esteem - Тест "Восхождение" (30 вопросов)
...
**1. Диалог с психологом**
Просто напишите о том, что вас беспокоит:
• Сны, стресс, отношения
• Страхи, тревога, депрессия
• Гнев, обиды, прощение
• Мечты и цели

**2. Экспресс-анализ личности**
• После 10 сообщений в диалоге
• Краткий психотип и рекомендации
• Подходящие профессии

**3. Тест "Восхождение"**
• 30 профессиональных вопросов
• 5 блоков: самооценка, страхи, гнев, предназначение, отношения
• Детальный анализ + рекомендации из книги
...
**Полный психоанализ**
• 7 глубоких вопросов
• Анализ по Юнгу, Фрейду, MBTI, Big Five
• Детальный профиль личности
• HR-рекомендации и образовательная траектория

**Личная консультация**
• Индивидуальная работа 1-2 часа
...
/start - главное меню
/self_esteem - тест "Восхождение" (30 вопросов)
/consultation - записаться на личную консультацию
/help - эта справка
...
Все анализы строго конфиденциальны и анонимны.
Ваши данные не передаются третьим лицам.

━━━━━━━━━━━━━━━━━━━━━━
**💡 КАК ПОЛУЧИТЬ МАКСИМУМ:**

1. Будьте искренни в ответах
2. Отвечайте развёрнуто (не односложно)
3. Если не понял - скажите "не понял"
4. Можете сменить тему в любой момент

━━━━━━━━━━━━━━━━━━━━━━
💙 **Я здесь, чтобы помочь вам найти себя!**
"""
