...
""",
            ...
            # Психологическая консультация - Вариант A (текущий)
            PromptVariant(
...
""",
                description="Стандартный подход к психологической поддержке"
            ),
...
СТИЛЬ: Сочетание теплоты и профессионализма. 200-350 слов.
""",
                description="Поддержка + практические техники для самопомощи"
            )
        ]
