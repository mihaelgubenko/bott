...
class PromptABTesting:
    ...
    def load_default_prompts(self):
        ...
        default_prompts = [
            # Экспресс-анализ - Вариант A (текущий) - только для HR
            PromptVariant(
                id="express_analysis_a",
                type=PromptType.EXPRESS_ANALYSIS,
                name="Стандартный HR экспресс-анализ",
                template="""
...
""",
                description="Стандартный промпт для HR экспресс-анализа"
            ),
            
            # Экспресс-анализ - Вариант B (более персонализированный) - только для HR
            PromptVariant(
                id="express_analysis_b",
                type=PromptType.EXPRESS_ANALYSIS,
                name="Персонализированный HR экспресс-анализ",
                template="""
...
🎯 Идеальная среда для вас: [где вы будете успешны в карьере]
📚 Что изучать: [персональные рекомендации для развития]
🚀 Следующий шаг: [конкретное действие для карьеры]

СТИЛЬ: Дружелюбный, мотивирующий, с примерами. До 250 слов.
""",
                description="Более персонализированный подход для HR с обращением на 'вы'"
            ),
